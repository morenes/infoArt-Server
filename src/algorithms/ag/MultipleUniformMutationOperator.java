...
/**
 * Operador de mutacion Multiple Uniform 
 * @author David Gil Galvan
 */
public class MultipleUniformMutationOperator implements GeneticOperator{
     ...
     */
    public MultipleUniformMutationOperator(double[] vmin, double[] vmax) {
        this.vmin=vmin;
        this.vmax=vmax;        
    }
     ...
     * @param a_candidateChromosomes Lista con un unico cromosoma para mutarlo     
     */
    ...
    protected void mutateGene(Gene[] genes, Random a_generator) {
        ...
        int n=a_generator.nextInt(genes.length);
        for (int i=0;i<n;i++) {
