...
/**
 * Operador de cruce heuristico 
 * @author David Gil Galvan
 */
public class HeuristicCrossoverOperator implements GeneticOperator{
    
    /**
     * Operacion de cruce heuristico
    ...
    public void operate(Population a_population, java.util.List a_candidateChromosomes) {
        ...
        for (int j = 0; j < firstGenes.length; j++) {
            ...
            gene1.setAllele(new Double(firstAllele +(r*(firstAllele -secondAllele))));
            gene2.setAllele(new Double(secondAllele+(r*(secondAllele-firstAllele ))));
        }
